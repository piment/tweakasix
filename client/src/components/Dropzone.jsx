...
import { textureAdd, textureClear } from '../features/TextureReducer'
...
function MyDropzone({
  ...
  const downloadBP = () => {
    const fileUrl =
      model == 1
        ? 'guitar/blueprints/ES335-Blueprint.png'
        : 'guitar/blueprints/Tele-Blueprints.zip'
    ...
    fetch(fileUrl)
      ...
      .then((blob) => {
        ...
        downloadLink.download =
          model == 1 ? 'ES335-Blueprint.png' : 'Tele-Blueprints.zip'
  ...
  const onDrop = useCallback((acceptedFiles) => {
    ...
    axios
      .post(`http://localhost/api/upload`, formData, {
        headers: {
        ...
        <form encType='multipart/form-data'>
          <section className='dropzone-container'>
            <div {...getRootProps()} className='dropzone-div'>
              ...
              <div
                className={
                  files.length !== 0 ? 'dragtext-hidden' : 'dragtext-visible'
                }
              >
                {isDragActive ? (
                  ...
                  <>
                    <div className='dropspace'>
                      ...
                      <a
                        href='guitar/blueprints/ES335-Blueprint.png'
                        download={'ES335-Blueprint.png'}
                      >
                        <button
                          onClick={(e) => {
                            e.preventDefault()
